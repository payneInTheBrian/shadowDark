									...
									<div className="modal-dialog bg-dark">
										<form className="modal-content" encType="multipart/form-data" action={`/api/post/editPost/${post.id}?_method=PATCH`} method="POST" onSubmit={handleUpdate}>
											...
											<div className="modal-body dark-purple">
												...
												<div className="mb-3">
													<label htmlFor="attack4" className="form-label text-light">Attack4</label>
												...
												<div className="mb-3">
													<label htmlFor="talent6" className="form-label text-light">Talent6</label>
												...
												<div className="mb-3">
													<label htmlFor="gear16" className="form-label text-light">Gear 16</label>
												...
												<div className="mb-3">
													<label htmlFor="imgUpload" className="form-label text-light">New Media</label>
													<input type="file" className="form-control" id="imageUpload" name="file" />
												</div>
											</div>
											<div className="modal-footer dark-purple">
												<button type="button" className="btn purple-btn" data-bs-dismiss="modal">Cancel</button>
												<button className="btn purple-btn">Update Character</button>
											</div>
										</form>
									</div>
								</div>
